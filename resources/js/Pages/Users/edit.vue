...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="block max-w-7xl mx-auto sm:px-6 shadow-lg  lg:px-8 w-1/3">
                <div>
                    Change Data
                </div>
                <form @submit.prevent="form.put(`${user.id}`)">
                ...
                <form @submit.prevent="">
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            type="text"
                            class="mt-1 block w-full"
                            v-model="formPassword.newPassword_confirmization"
                            required
                            autocomplete="lastName"
                        />

                        <InputError class="mt-2" :message="form.errors.newPassword_confirmization" />
                    </div>
